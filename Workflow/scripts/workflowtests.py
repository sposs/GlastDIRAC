...
m1i = stepdefinition.createModuleInstance(moduledefinition.getType(), stepdefinition.getType())#This is optional
m1i.setValue('something', '14')#This is optional

wo = Workflow(name = 'a_test')
wo.addStep(stepdefinition)
stepInstance = wo.createStepInstance(stepdefinition.getType(), "step_1") #In fact this is not needed, but useful if there
#are some step parameters
